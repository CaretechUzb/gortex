...
func TestDaemonSkewWarning(t *testing.T) {
	cases := []struct{ name, daemonV, localV, want string }{
		...
		{"daemon newer", "v0.63.5+abcdef1", "v0.63.4+5f9ce2a",
			"warning: daemon v0.63.5+abcdef1 != binary v0.63.4+5f9ce2a — this binary is older than the running daemon — upgrade it (e.g. brew upgrade gortex)"},
		{"same version different build", "v0.63.4+aaaaaaa", "v0.63.4+bbbbbbb",
			"warning: daemon v0.63.4+aaaaaaa != binary v0.63.4+bbbbbbb — run 'gortex daemon restart' or upgrade this binary"},
		{"unparseable daemon version", "strawberry", "v0.63.5+abcdef1",
			"warning: daemon strawberry != binary v0.63.5+abcdef1 — run 'gortex daemon restart' or upgrade this binary"},
