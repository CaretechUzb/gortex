...
gortex repos [--json]        List every tracked repo with git head-commit SHA, last-indexed time, a freshness flag (MISSING when the path is gone), and a composite READY verdict
